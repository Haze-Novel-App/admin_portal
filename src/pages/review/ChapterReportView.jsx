    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', background: 'white' }}>
      ...
      <div style={{ padding: '20px 32px', borderBottom: '1px solid #E2E8F0', display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#fff' }}>
        <div>
          ...
          <h2 style={{ margin: 0, fontSize: 24, color: '#1A202C' }}>Analysis Report: {chapter.title}</h2>
          <div style={{ display: 'flex', gap: 16, marginTop: 10, fontSize: 13, color: '#718096', alignItems: 'center', flexWrap: 'wrap' }}>
            <span style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
              <Calendar size={14} /> Analyzed on: {formatDate(report.created_at)}
            </span>
            <span style={{ display: 'flex', alignItems: 'center', gap: 5, background: '#EBF8FF', color: '#2B6CB0', padding: '4px 12px', borderRadius: 6, fontWeight: 600, border: '1px solid #BEE3F8' }}>
              <FileText size={14} /> {wordCount.toLocaleString()} words
            </span>
            <span style={{ display: 'flex', alignItems: 'center', gap: 5, background: '#FAF5FF', color: '#6B46C1', padding: '4px 12px', borderRadius: 6, fontWeight: 600, border: '1px solid #E9D8FD' }}>
